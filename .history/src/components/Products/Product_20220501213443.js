      ...
      <div className="content-left">
        ...
        <div className="img-down">
          <div className="img-small">
            <img src={snicker2} onClick={()=>setImglarge}/>
          </div>
          <div className="img-small">
            <img src={snicker3}onCl<img src={snicker2} onClick={()=>setImglarge} />
          </div>
          <div className="img-small">
            <img src={snicker4}onCl<img src={snicker2} onClick={()=>setImglarge} />
          </div>
        </div>
      </div>
