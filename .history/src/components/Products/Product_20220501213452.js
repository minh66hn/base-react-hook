      ...
      <div className="content-left">
        ...
        <div className="img-down">
          <div className="img-small">
            <img src={snicker2} onClick={()=>setImglarge(snick2)}/>
          </div>
          <div className="img-small">
            <img src={snicker3}onCl<img src={snicker2} onClick={()=>setImglarge(snick3)} />
          </div>
          <div className="img-small">
            <img src={snicker4}onCl<img src={snicker2} onClick={()=>setImglarge(snick4)} />
          </div>
        </div>
      </div>
