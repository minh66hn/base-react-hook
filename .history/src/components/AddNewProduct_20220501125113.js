...
const AddNewProduct = () => {
  ...
  const handleClickbtn = () => {
    ...
    localStorage.setItem("ListProducts", object);
    ListProducts = localStorage.getIteme

    if (ListProducts) {
      let arr = localStorage.getItem("ListProducts");
      arr.push(JSON.stringify(object));
      localStorage.setItem("ListProducts", arr);
      console.log(arr);
    } else {
